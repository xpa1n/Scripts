...
sx:Toggle("Auto Open Egg (World 2)",function(t)
getgenv().eggf2 = t;
...
sx:Button("Auto Redeem Codes",function(t)
...
sy:Button("Quest NPC",function(t)
...
sy:Dropdown("East Town Mobs",{"Marine1", "Marine2", "MarineX"},function(t)
    getgenv().etmname = t;
end)

sy:Toggle("Toggle Farm",function(t)
...
sy:Dropdown("Buggy's Town Mobs",{"Minion1", "Minion2", "Tamer", "Cyclist"},function(t)
    getgenv().btname = t;
end)
...
sy:Dropdown("Maple Village Mobs",{"SlasherCrew1", "SlasherCrew2", "CatBro1", "CatBro2", "Hypno"},function(t)
    getgenv().mpname = t;
end)
...
sy:Dropdown("Baratia Mobs",{"GoldCrew1", "GoldCrew2", "Jin", "Marble"},function(t)
    getgenv().baraname = t;
end)
...
sy:Dropdown("Sawfish Park Mobs",{"Fish1", "Fish2", "Chomp", "Karate", "Squid"},function(t)
    getgenv().sawname = t;
end)
...
local sw2 = s:Tab("Mob Farm (World 2)")

sw2:Label("-- Snowy Hills --")

sw2:Button("Quest NPC",function(t)
...
sw2:Dropdown("Snowy Hills Mobs",{"LittleBunny", "MidBunny", "BigBunny", "Afro", "Jester"},function(t)
    getgenv().snowyn1 = t;
end)

sw2:Toggle("Toggle Farm",function(t)
getgenv().togglefarm1 = t;
while task.wait() and getgenv().togglefarm1 do
...
sw2:Dropdown("Desert Kingdom Mobs",{"BombMan", "Kilo", "Batter", "Mole", "Spikes", "Steel"},function(t)
    getgenv().desert = t;
end)
...
sye:Dropdown("Select Boss",{"Cap Freeman", "Boogie", "Slasher", "Don Craig", "Sawfish", "Muncher", "Croc"},function(t)
    getgenv().bossname = t;
end)

sye:Toggle("Toggle Farm Boss",function(t)
    getgenv().bossfarm = t;
end)
...
sqwe:Toggle("Infinite Jump",function(t)
...
sc:Label("")
sc:Label("")
sc:Label("Script made by pa1n#8015 & Arpon AG#6612")
sc:Label("")
