...
local JaninaKey = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()
local Window = JaninaKey:CreateWindow({
    Name = "Janina Key Checker",
    LoadingTitle = "Janina Key Checker",
    LoadingSubtitle = "by pa1n",
    ConfigurationSaving = {
    Enabled = true,
    FolderName = "Janina",
